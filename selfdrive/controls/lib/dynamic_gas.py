...
class DynamicGas:
  ...
  def set_profile(self):
    ...
    if self.dp_profile == DP_ECO:
      ...
      y = [0.85, 1.150, 1.198, 1.233, 1.333, 1.42, 1.415, 1.40, 1.395, 1.29, 1.188, 1.185, 1.182, 1.175, 1.07, 0.865, 0.757, 0.645]
      self.x_lead_mod_x = [8.1, 12.15, 25.24, 35 , 50 ]
    elif self.dp_profile == DP_SPORT:
      #km/h[0,   5,    10,    15,   19,  22,   25,     29,      36,      43,   54,    64,    72,    87,    104,   117,  128  144]
      y = [1.10, 1.2197, 1.315, 1.3240, 1.4253, 1.528, 1.5289, 1.5295, 1.585, 1.48, 1.476, 1.455, 1.452, 1.348, 1.342, 1.2381, 1.235, 1.28]
      self.x_lead_mod_x = [4.1, 6.15, 8.24, 10 , 15 ]
    else:
      #km/h[0,   5,    10,   15,   19,  22,   25,   29,   36,   43,   54,   64,   72,   87,   104,  117,  128   144]
      y = [1.05, 1.042, 1.238, 1.233, 1.23, 1.232, 1.231, 1.230, 1.30, 1.28, 1.224, 0.21, 0.20, 0.20, 0.19, 0.19, 0.17, 0.15]
